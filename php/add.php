<?php
/*
 * 1,2,...9の数をこの順序で'+', '-'またはなにもせず結果が
 * 100となるあらゆる組み合わせを出力するプログラムを記述
 * 例えば1+2+34-5+67-8+9=100となる
 */
...
function f($sum, $number, $index) {
	...
	$concatenatedNumber = $number >= 0 ?
		10 * $number + $VALUES[$index] : 10 * $number - $VALUES[$index];
